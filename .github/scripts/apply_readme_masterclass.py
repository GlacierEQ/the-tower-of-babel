...
start = source.index("def render_readme(registry: TowerRegistry) -> str:")
end = source.index("\ndef render_runtime_registry", start)

replacement = r'''def render_readme(registry: TowerRegistry) -> str:
