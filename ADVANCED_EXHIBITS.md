...
| **CUDA** | Audited reference attention kernel — stable softmax and GPU validation without a FlashAttention claim | `hardware_gated` / `hardware` | [`advanced_reference_attention.cu`](languages/cuda/advanced_reference_attention.cu) |
